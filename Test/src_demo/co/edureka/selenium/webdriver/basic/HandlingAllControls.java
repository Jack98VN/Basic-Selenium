...
//Launch the Edureka Website
        ...
        driver.navigate().to("https://learning.edureka.co/my-profile/learning.edureka.co/my-profile");
        Thread.sleep(2000);
        System.out.println("a");
        System.out.println("abc");
        driver.navigate().to("https://learning.edureka.co/onboarding/careerinterests/learning.edureka.co/onboarding/careerinterests");
        Thread.sleep(3000);
        ...
        Thread.sleep(2000);
        driver.navigate().to("https://learning.edureka.co/learning.edureka.co");
        Thread.sleep(2000);
